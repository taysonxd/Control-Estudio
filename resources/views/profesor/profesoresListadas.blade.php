    ...
    <div class="row-fluid justify-content-center">
        <div class="col-md-14">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="tabla-profesores" class="table table-striped table-bordered display dt-responsive no-wrap">
...
<script type="text/javascript">
    ...
    var table = $("#tabla-profesores").DataTable({
        responsive: true,
        ajax : {
            type : "POST",
            url : "{{ route('dataTablesProfesores') }}",
            dataSrc : ""
        },
        language : {
    ...
    function abrir(id){
        ...
        if(id !== null){
            ...
            var url = "{{ url('profesor/editar') }}";
            url += '/'+id;
        }else{

            var url = "{{ route('vista-profesor') }}";
        }
