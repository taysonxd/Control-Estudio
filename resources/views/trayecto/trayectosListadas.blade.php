    ...
    <div class="row-fluid justify-content-center">
        <div class="col-md-14">
            <div class="card">
                ...
                <div class="card-body">
                    <table id="tabla-materias" class="table table-striped table-bordered display dt-responsive no-wrap">
                        <thead>
                            <tr>
                                <th>Materia</th>
                                <th>Acción</th>
...
<script type="text/javascript">
    ...
    function abrir(id){
        ...
        if(id !== null){
            ...
            var url = "{{ url('trayecto/editar') }}";
            url += '/'+id;
        }else{

            var url = "{{ route('vista-trayecto') }}";
        }
